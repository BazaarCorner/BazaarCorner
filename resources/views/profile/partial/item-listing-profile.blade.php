<div class="container-fluid" id="user_content">
    <div class="row">
        <div class="col-md-12">
            <dl class="sub-nav-user">
              <dt>Sort by:</dt>
              <dd class="active"><a href="#">Most Recent</a></dd>
              <dd><a href="#">Most Bought</a></dd>
              <dd><a href="#">Half the tag price</a></dd>
            </dl>
        </div>
    </div>
    <div class="row">
        ...
        <div class="row">
            <div class="col-md-3" style="margin-bottom: 30px">
                ...
                <div class="row user-product-action">
...
<!--                            <div class="col-xs-3"><a href="#" class="favorite-button user-product">favorite</a></div>
                ...
                <div class="user-product">
                    ...
                    <div class="ItemAction">
                        <div class="wrap"></div>
                        <div class="wrap-desc">
                        <span class="spanq4">Striped Appeal</span><br />
                        <span class="spanq3">$10</span> &nbsp;&nbsp;<span class="spanq4 line-through">$25 tag price</span>
                        </div>
                    </div>
                    <div class="ItemAction2">
                        <div class="wrap-big"></div>
                        <div class="wrap-big-desc">
                            <div class="row">
                                <div class="col-md-7"><a href="#"><span class="spanq4" style="text-decoration: underline;font-weight: bold">Bottle Table Decoration</span></a></div>
                                <div class="col-md-5"><span class="spanq1" style="float:right">$20</span><div style="clear: both"></div><br /><span class="spanq4 line-through">$25 tag price</span></div>
                            </div><br />
                            <div class="row" style="margin-top: 20px;margin-left: 0px">
                                <div class="col-md-7 centered"><a href="#" class="button small radius"><em>Add to Cart</em></a></div>
                            </div>
                            <div class="row" style="margin-top: 42px">
                                <div class="col-md-9" style="margin-top: 15px"><span class="spanq4" style="color: yellow;">Category:</span> &nbsp;&nbsp;<a href="#"><span class="spanq4" style="color: yellow;text-decoration: underline">Gadgets</span></a></div>
                                <div class="col-md-3"><a href="#"  data-reveal-id="productModal"><img src="img/icons/view-details.png" /></a></div>
                            </div><br />
                        </div>
                    </div>
                </div>
